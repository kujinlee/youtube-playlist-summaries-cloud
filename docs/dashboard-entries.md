...
Three mutations added (manifest 64 → 67, declared sum 629 → 632), each proved to go red
**via the case it names** over a control proved green first: the question reverting to a
span (2 cases), the choose affordance removed (1), the PR state re-wearing `when` (2).
