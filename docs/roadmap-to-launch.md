...
- [x] **backlog #140 — 🟢 collapse `SweepPolicy` to a single `run(fn)`.** ✅ **DONE 2026-09-18.** The only proposed change
...
- **`master` is clean** — tsc clean, **2845 unit / 275 suites** green, plus **522 integration**
